            ...
            <div class="overflow-hidden shadow sm:rounded-md">
                <div class="px-4 py-5 bg-white sm:p-6">
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                          ...
                          'transaction' => $transaction->id,
                      ]) }}" class="block w-full px-4 py-2 text-center text-white bg-green-500 rounded approve-btn aprove-btn">
                                        Approve & Send
                                    </a>
                            ...
                            'event' => $event->id,
                            'transaction' => $transaction->id,
                        ]) }}" method="POST" class="block" onsubmit="return confirm('Hapus transaction {{ $transaction->name }}?')">
                                        @csrf
                                        @method('DELETE')
