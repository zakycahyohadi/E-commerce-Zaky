        ...
        <div class="xl:px-[60px]">
            ...
            <div class="flex flex-wrap items-center justify-center gap-y-[30px] lg:justify-between lg:items-start">
                <div class="max-w-[500px]">
                    ...
                    <h1 class="text-[32px] font-bold mt-5 mb-[30px] text-butter-yellow">
                        {{ $event->name }}
                    </h1>
                    ...
                    <div class="flex flex-col gap-5 mb-[30px]">
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <input type="text" name="name" placeholder="Write your complete name"
                                class="px-5 py-[13px] placeholder:text-secondary placeholder:font-normal font-semibold text-base rounded-[50px] bg-primary border-2 border-transparent border-solid focus:border-persian-pink focus:outline-none"
                    ...
                    <div class="flex flex-col gap-4">
                        <h6 class="text-xl font-semibold text-butter-yellow">
                            Payment Details
                        </h6>
                        ...
                        <!-- Grand total -->
                        <div class="inline-flex items-center justify-between gap-4">
                            <p class="text-base font-medium text-butter-yellow">
                                Grand total
                            </p>
                ...
                <form action="{{ route('checkout-pay') }}" method="POST"
                    class="bg-primary p-5 rounded-2xl flex flex-col gap-5 max-w-[380px] w-full" id="paymentForm">
                    @csrf
                    @method('POST')
